...
\begin{frame}
	...
	\footnotesize{
		\begin{thebibliography}{99}
			\setbeamertemplate{bibliography item}[triangle]
			\bibitem[Folkestad 2012]{p3} Folkestad, L., Hald, J. D., Hansen, S., Gram, J., Langdahl, B., Abrahamsen, B., Brixen, K. (2012).
			...
			\vspace{1mm}
			\bibitem[Panyasantisuk et al., 2015]{p4} Panyasantisuk, J., Pahr, D. H., Gross, T., and Zysset, P. K. (2015).
