...
ResultFolder = os.path.join(WorkingDirectory,'04_Results/02_Individuals_Matching')
...
MatchedControl = MatchedControl.drop_duplicates('Sample Number')
MatchedOI = MatchedOI.loc[MatchedControl.index]


MatchedOI.to_csv(ResultFolder+'/Matched_OI.csv',index=False)
MatchedControl.to_csv(ResultFolder+'/Matched_Healthy.csv',index=False)
