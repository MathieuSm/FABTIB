...
MatchingFolder = os.path.join(WorkingDirectory,'04_Results/03_Individuals_Matching')
...
Matched_Healthy = pd.read_csv(os.path.join(MatchingFolder,'Matched_Control.csv'))
...
## Histograms
Groups = ['FullControl', 'FullOI', 'MatchedControl', 'MatchedOI']
Iteration = 0
