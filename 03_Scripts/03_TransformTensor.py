...
DataFolder = os.path.join(WorkingDirectory,'04_Results',DataSubFolders[DataGroup],'01_FabricElasticity')
ResultsFolder = os.path.join(WorkingDirectory,'04_Results',DataSubFolders[DataGroup],'02_TransformedTensors')
