...
ResultsFolder = os.path.join(WorkingDirectory,'04_Results/01_ROI_Analysis')
...
PipelineFile  = open(os.path.join(WorkingDirectory, '03_Scripts', '01_ROIAnalysisPipeline.txt'), 'r')
