...
# 04 Select stack
StackNumber3 = CT_Scan[2*StackHeight:,:,:]
SoftTissue, TrabBone, CortBone = np.unique(StackNumber3)
...
ParametersDataFrame.to_csv(os.path.join(DataFolder, DataSubFolders[DataGroup][:-14] + 'ROI.csv'),
                           sep=';', line_terminator=';\n', index=False)