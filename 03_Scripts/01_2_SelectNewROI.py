...
ReferenceFolder = os.path.join(WorkingDirectory,'04_Results/01_ROI_Analysis/01_OI_ROIs/01_Resized_ROIs')
ResultsFolder = os.path.join(WorkingDirectory,'04_Results/01_ROI_Analysis/02_OI_FabricElasticity')
